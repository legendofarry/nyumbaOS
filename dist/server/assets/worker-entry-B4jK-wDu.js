...
function Mt(e, r) {
  var t;
  return { mode: e, plugins: r.plugins, refs: r.refs || /* @__PURE__ */ new Map(), features: (t = r.features) != null ? t : 63 ^ (r.disabledFeatures || 0), depthLimit: r.depthLimit || Wn, types: /* @__PURE__ */ new Map() };
}
function Lt(e) {
...
function Yt(e, r, t) {
  e.base.types.set(r, t);
}
function de(e, r, t, n2) {
  if (e.base.types.get(t) !== n2) throw new O(r);
}
...
function So(e, r) {
  return Yt(e, r.s, 22), b(e, r.i, b(e, r.s, ee$1()).p);
}
function mo(e, r, t) {
...
function No(e, r, t) {
  Yt(e, t.i, 31);
  let n2 = b(e, t.i, re()), a = t.a, s = a.length;
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-D1UDziH1.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DRMkp4_G.js").then((n2) => n2.r),
